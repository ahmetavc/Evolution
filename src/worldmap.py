...
class Map:
    ...
    def getEnvironmentOfCreature(self,creature):
        ...
        creaturePos = np.array((creature.creatureStats[creature.POS_POSITION_Y],creature.creatureStats[creature.POS_POSITION_X]))
    ...
    def render(self, game):
        ...
        for creature in game.creatures:
            position = (creature.creatureStats[creature.POS_POSITION_Y],creature.creatureStats[creature.POS_POSITION_X])
